	...
	<div class="details">
		...
		<router-link v-else class="details__mobile-back-button" to="/">
			<svg width="11" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M8.9443 17.4446C9.14493 17.6342 9.39836 17.75 9.69403 17.75C10.2959 17.75 10.75 17.2867 10.75 16.6971C10.75 16.4022 10.6338 16.139 10.4332 15.9389L3.316 9L10.4332 2.06107C10.6338 1.86101 10.75 1.58724 10.75 1.30295C10.75 0.713297 10.2959 0.25 9.69403 0.25C9.39836 0.25 9.15549 0.355295 8.9443 0.555355L1.10903 8.18923C0.876716 8.41035 0.75 8.69464 0.75 9C0.75 9.30536 0.876716 9.56859 1.10903 9.80024L8.9443 17.4446Z" fill="white"/>
			</svg>
		</router-link>
		<div class="details__content-wrapper">
			...
			<div class="details__content">
				...
				<p class="details__price">{{this.selectedAd.price + ' ' + this.selectedAd.currency}}</p>
				...
				<button type="button" class="details__contact" data-bs-toggle="modal" data-bs-target="#exampleModal">
					Kapcsolatfelvétel
				</button>
			</div>
		</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title" id="exampleModalLabel">Kapcsolatfelvétel</h3>
					...
					<div class="modal-body">
						<dl>
							...
							<dt>Telefon:</dt>
							<dd>
								<span v-for="item in this.selectedAd.contact.parsedPhoneNumbers" :key="item">{{item}}</span>
							</dd>
						</dl>
					</div>
				</div>
